        ...
        >
          ...
          <div className="mt-10 pt-8 border-t border-border/50 text-center">
            ...
            <div className="mt-3 flex flex-wrap justify-center gap-2">
              <span className="px-3 py-1 bg-secondary rounded-full text-xs font-medium">admin@example.com</span>
              <span className="px-3 py-1 bg-secondary rounded-full text-xs font-medium">sarah@example.com (Mgr)</span>
              <span className="px-3 py-1 bg-secondary rounded-full text-xs font-medium">alice@example.com (Emp)</span>
            </div>
